...
bastille start $JAIL
bastille pkg $JAIL install -y puppet${puppet_version} puppetdb${puppet_version} postgresql${postgresql_version}-server postgresql${postgresql_version}-contrib postgresql${postgresql_version}-client sudo icu
jexec $JAIL puppet apply < manifests/common.pp
